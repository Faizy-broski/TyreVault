...
export default function UpdatePasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (user) {
      ...
      if (role === 'super_admin') { router.push('/admin/dashboard'); return }
      if (role === 'fitter')      { router.push('/fitter/dashboard'); return }
    }
    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 px-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-sm ring-1 ring-black/5">
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-zinc-500">Choose a password to secure your account.</p>
        </div>
