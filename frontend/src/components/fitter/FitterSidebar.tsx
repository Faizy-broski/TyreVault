      ...
      <div className="px-4 py-5 border-b border-zinc-100">
        <div className="flex items-center gap-1.5">
          ...
          <div className="leading-none">
            <p className="text-xs font-black text-zinc-900 tracking-wide">TYRE VAULT</p>
            <p className="text-[9px] text-zinc-400 tracking-tight">FITMENT PORTAL</p>
          </div>
        </div>
      </div>
