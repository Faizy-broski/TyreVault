...
router.post('/',              ctrl.postFitmentCentre)
router.get('/:id',            ctrl.getFitmentCentre)
router.delete('/:id',         ctrl.deleteFitmentCentre)
...
router.get('/:id/jobs/:jobId',    ctrl.getCentreJob)
router.patch('/:id/jobs/:jobId',  ctrl.patchCentreJob)
